...
/**
 * Floating pill that shows the live count of the customer's selection and
 * links to the "My Selection" page. Hidden while the list is empty. Sits
  ...
  return (
    <div className={`fixed left-1/2 z-40 -translate-x-1/2 ${bottomClass}`}>
      ...
      >
        ...
        <span>
          My Selection · {count} item{count === 1 ? '' : 's'}
        </span>
